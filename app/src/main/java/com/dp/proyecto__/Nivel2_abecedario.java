...
public class Nivel2_abecedario extends AppCompatActivity {
    ...
    private void checkEnd(){
        if(iv_11.getVisibility() ==View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Nivel2_abecedario.this);
            alertDialogBuilder
                    ...
                    .setPositiveButton("NEW", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), Nivel2_abecedario.class);
    ...
    private void frontOfCardsResuorse(){
        image101 = R.drawable.h;
        image102 = R.drawable.i;
        image103 = R.drawable.j;
        image104 = R.drawable.k;
        image105 = R.drawable.l;
        image106 = R.drawable.m;
        image107 = R.drawable.n;
        image108 = R.drawable.o;
        image201 = R.drawable.hh;
        image202 = R.drawable.ii;
        image203 = R.drawable.jj;
        image204 = R.drawable.kk;
        image205 = R.drawable.ll;
