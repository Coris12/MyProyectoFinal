...
public class Nivel3_Abecedario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton botonRegresar = (ImageButton)  findViewById(R.id.btn8);
    ...
    private void doStuff(ImageView iv, int card){
        if (cardsArray[card] ==101){
            ...
            final MediaPlayer mediaPlayer101 = MediaPlayer.create(this, R.raw.p);
            ...
            final MediaPlayer mediaPlayer102 = MediaPlayer.create(this, R.raw.q);
            ...
            final MediaPlayer mediaPlayer103 = MediaPlayer.create(this, R.raw.r);
            ...
            final  MediaPlayer mediaPlayer104 = MediaPlayer.create(this, R.raw.s);
            ...
            final MediaPlayer mediaPlayer105 = MediaPlayer.create(this, R.raw.t);
            ...
            final MediaPlayer mediaPlayer106= MediaPlayer.create(this, R.raw.u);
            ...
            final  MediaPlayer mediaPlayer107 = MediaPlayer.create(this, R.raw.v);
            ...
            final MediaPlayer mediaPlayer108 = MediaPlayer.create(this, R.raw.w);
            ...
            final MediaPlayer mediaPlayer109 = MediaPlayer.create(this, R.raw.x);
            mediaPlayer109.start();
            mediaPlayer109.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mp) {
                    mediaPlayer109.release();
                }
            });
        }
        else if (cardsArray [card] ==110){
            iv.setImageResource(image110);
            final  MediaPlayer mediaPlayer110 = MediaPlayer.create(this, R.raw.y);
            mediaPlayer110.start();
            mediaPlayer110.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mp) {
                    mediaPlayer110.release();
                }
            });
        }
